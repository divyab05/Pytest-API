...
class TestSSP_GetArticlesAPI(common_utils):
    ...
    @pytest.mark.self_service_portal_api_sp360commercial
    @pytest.mark.self_service_portal_api_sp360commercial_smoke
    ...
    @pytest.mark.self_service_portal_api_sp360commercial_smoke
    @pytest.mark.regression
    @pytest.mark.parametrize("test_data", common_utils.read_excel_data_store("ssp_services","./sp360commercial/ArticlesAPITestData.xlsx","TC_02_article_list"))
    ...
    @pytest.mark.self_service_portal_api_sp360commercial_smoke
    @pytest.mark.regression
    @pytest.mark.parametrize("test_data",common_utils.read_excel_data_store("ssp_services", "./sp360commercial/ArticlesAPITestData.xlsx","TC_03_article_list_mtr_product"))
    ...
    @pytest.mark.self_service_portal_api_sp360commercial_smoke
    @pytest.mark.regression
    @pytest.mark.parametrize("test_data", common_utils.read_excel_data_store("ssp_services","./sp360commercial/ArticlesAPITestData.xlsx","TC_04_coveo_search"))
    ...
    @pytest.mark.self_service_portal_api_sp360commercial_smoke
    @pytest.mark.regression
    @pytest.mark.parametrize("test_data", common_utils.read_excel_data_store("ssp_services","./sp360commercial/ArticlesAPITestData.xlsx","TC_05_suggested_article_list"))
    def test_05_verify_suggested_article_list_api(self, rp_logger, resource, test_data):
        """
        his test validates if suggested article list is returned for a given plan
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")

        res, status_code_list = resource['articles_api'].getSuggestedArticleList(test_data)

        # Validate the response of Suggested Article List API:
        assert self.validate_expected_and_actual_response_code(200, status_code_list) is True

        # Verify the schema of Suggested Article List:
        with open(self.prop.get('SELFSERVICEPORTAL', 'suggested_article_list_schema')) as schema:
            expected_schema = json.load(schema)
    ...
    @pytest.mark.self_service_portal_api_sp360commercial_smoke
    @pytest.mark.regression
    @pytest.mark.parametrize("test_data", common_utils.read_excel_data_store("ssp_services",
                                                                                 "./sp360commercial/ArticlesAPITestData.xlsx",
                                                                                 "TC_06_suggest_dev_article_list"))
    def test_06_verify_suggested_article_list_with_device_api(self, rp_logger, resource, test_data):
        """
        This test validates if suggested article list is returned for a given plan and device type
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")

        res, status_code_list = resource['articles_api'].getSuggestedArticleListWithDevice(test_data)
