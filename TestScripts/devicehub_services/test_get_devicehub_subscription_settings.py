...
def resource(general_config, app_config, custom_logger):
    req = Get_Subscription_settings(general_config, app_config, custom_logger)
    yield req


class Test_get_devicehub_subscription_settings(common_utils):
    ...
    def test_get_devicehub_subscription(self, resource, generate_access_token, custom_logger):
        resp = resource.send_get_devicehub_subscription_settings("valid", generate_access_token, None)
        ...
        expected_schema = self.read_json_file('subscription_settings.json', 'devicehub_services')
        ...
        assert_that(str(resp['response_body']['automaticUpdatesDisabled']), equal_to("False"))
    ...
    @pytest.mark.device_hub_sp360commercial
    @pytest.mark.device_hub_sp360commercial_reg
    def test_get_devicehub_subscription_settings(self, resource, generate_access_token, custom_logger):
        resp = resource.send_get_devicehub_subscription_settings("valid", generate_access_token, "invalid_path")
    ...
    @pytest.mark.device_hub_sp360commercial
    @pytest.mark.device_hub_sp360commercial_reg
    def test_get_devicehub_subscription_settings_passing_expired_token(self, resource, generate_access_token,
                                                                       custom_logger):
        resp = resource.send_get_devicehub_subscription_settings("invalid_token", generate_access_token, None)
