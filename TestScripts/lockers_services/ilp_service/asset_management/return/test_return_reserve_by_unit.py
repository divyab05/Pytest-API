...
def resource(app_config, client_token, get_product_name):
    reserveWithPin = {'app_config': app_config,
                      'returnUnit': ReserveWithPin(app_config, client_token),
...
class TestReturnReserveByUnit(common_utils):
    ...
    def test_reserve_by_unit_for_recipient_to_recipient(self, rp_logger, resource):
        ...
        res, status_code = resource['returnUnit'].verify_reserve_with_pin_based_on_unit(locker_bank=locker_bank,
    ...
    def test_reserve_by_unit_for_department_to_recipient_when_departmentMail_is_false(self, rp_logger, resource):
        """
        This test validates the reservation of return flow for Department to Recipient (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserve_by_unit_for_dedicated_recipient_locker(self, rp_logger, resource):
        """
        This test validates the reservation of dedicated recipient locker (positive scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserve_by_unit_for_dedicated_department_locker(self, rp_logger, resource):
        """
        This test validates the reservation dedicated locker (positive scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    @pytest.mark.regressioncheck_lockers
    def test_reserve_by_unit_duplicate_tracking_id(self, rp_logger, context, resource):
        """
    ...
    @pytest.mark.regressioncheck_lockers
    def test_reserve_by_unit_for_already_reserved_unit(self, rp_logger, context, resource):
        """
    ...
    def test_reserveWithPin_by_unit_for_when_no_size_provided(self, rp_logger, resource):
        """
        This test validates the reservation of return flow when no size is provided (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_by_unit_for_when_no_reservationType_provided(self, rp_logger, resource):
        """
        This test validates the reservation of return flow when no reservation type is provided (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_by_unit_for_when_no_trackingID_provided(self, rp_logger, resource):
        """
        This test validates the reservation of return flow when no tracking ID is provided(negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_by_unit_for_when_no_climateType_provided(self, rp_logger, resource):
        """
        This test validates the reservation of return flow when no climate type is provided (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_by_unit_for_when_invalid_recipient_provided(self, rp_logger, resource):
        """
        This test validates the reservation of return flow for invalid recipient (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_by_unit_for_when_invalid_department_provided(self, rp_logger, resource):
        """
        This test validates the reservation of return flow for invalid department (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_by_unit_for_when_invalid_resource(self, rp_logger, resource):
        """
        This test validates the reservation of return flow for invalid resource (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_by_unit_for_when_invalid_access_token(self, rp_logger, resource):
        """
        This test validates the reservation of return flow for invalid access token (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_by_unit_for_when_invalid_lockerBank(self, rp_logger, resource):
        """
        This test validates the reservation of return flow for invalid locker bank (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
        ...
        res, status_code = resource['returnUnit'].verify_reserve_with_pin_based_on_unit(locker_bank="invalidBank",
                                                                                        locker_unit=locker_unit,
                                                                                        size=locker_size,
                                                                                        reservation_type="return",
                                                                                        accessible=""
    ...
    def test_reserveWithPin_by_unit_for_when_no_lockerBank(self, rp_logger, resource):
        """
        This test validates the reservation of return flow for no locker bank (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
        ...
        res, status_code = resource['returnUnit'].verify_reserve_with_pin_based_on_unit(locker_bank="",
                                                                                        locker_unit=locker_unit,
                                                                                        size=locker_size,
                                                                                        reservation_type="return",
                                                                                        accessible=""
