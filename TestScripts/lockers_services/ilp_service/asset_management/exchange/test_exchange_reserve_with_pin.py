...
def resource(app_config, client_token, get_product_name):
    reserveWithPin = {'app_config': app_config,
                      'exchange': ReserveWithPin(app_config, client_token),
...
class TestReserveExchange(common_utils):
    ...
    def test_reserveWithPin_recipient_to_recipient(self, rp_logger, resource):
        ...
        res, status_code = resource['exchange'].verify_reserve_with_pin_locker_api(locker_bank=locker_bank,
                                                                                   size=locker_size,
    ...
    def test_reserveWithPin_department_to_recipient_when_departmentMail_is_false(self, rp_logger, resource):
        """
        This test validates the reservation of exchange flow for Department to Recipient when department mail is false(negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_when_no_size_provided(self, rp_logger, resource):
        """
        This test validates the reservation of exchange flow for when no size is provided (negative (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_when_no_reservationType_provided(self, rp_logger, resource):
        """
        This test validates the reservation of exchange flow for when no reservation type is provided (negative(negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_when_no_trackingID_provided(self, rp_logger, resource):
        """
        This test validates the reservation of exchange flow for when no trackingID is provided (negative (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_when_no_climateType_provided(self, rp_logger, resource):
        """
        This test validates the reservation of exchange flow for when no climate type is provided (negative (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_when_invalidSize_provided(self, rp_logger, resource):
        """
        This test validates the reservation of exchange flow for when invalid size is provided (negative(negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_when_invalid_recipient_provided(self, rp_logger, resource):
        """
        This test validates the reservation of exchange flow when invalid recipient is provided (negative (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_when_invalid_resource(self, rp_logger, resource):
        """
        This test validates the reservation of exchange flow for when invalid resource is provided (negative (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_when_invalid_access_token(self, rp_logger, resource):
        """
        This test validates the reservation of exchange flow for when invalid access token is provided (negative(negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
    ...
    def test_reserveWithPin_when_invalid_lockerBank(self, rp_logger, resource):
        """
        This test validates the reservation of exchange flow for when invalid locker bank is provided (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
        ...
        res, status_code = resource['exchange'].verify_reserve_with_pin_locker_api(locker_bank="invalidBank",
                                                                                   size=locker_size,
                                                                                   reservation_type="exchange",
                                                                                   accessible=""
                                                                                   , refrigeration="", climate_type="",
    ...
    def test_reserveWithPin_when_no_lockerBank(self, rp_logger, resource):
        """
        This test validates the reservation of exchange flow for when no locker bank is provided (negative scenario)
        :return: return test status
        """
        test_name = sys._getframe().f_code.co_name
        rp_logger.info("###### TEST EXECUTION STARTED :: " + test_name + " ######")
        ...
        res, status_code = resource['exchange'].verify_reserve_with_pin_locker_api(locker_bank="", size=locker_size,
                                                                                   reservation_type="exchange",
                                                                                   accessible=""
                                                                                   , refrigeration="", climate_type="",
                                                                                   TrackingID=trackingID,
    ...
    # -----------------------Private Flow---------------------------------------
    @pytest.mark.regressioncheck_lockers
    def test_reserveWithPin_api_for_private_recipient_as_receiver(self, rp_logger, resource):
        """
    ...
    @pytest.mark.regressioncheck_lockers
    def test_reserveWithPin_api_for_private_recipient_as_depositor(self, rp_logger, resource):
        """
        This test validates the reservation of exchange flow for no locker bank (negative scenario)
        :return: return test status
        """
    ...
    def test_kiosk_reserveWithPin_recipient_to_recipient(self, rp_logger, resource, context):
        """
        This test validates the reservation of exchange flow for recipient to recipient (positive scenario)
        :return: return test status
        """
