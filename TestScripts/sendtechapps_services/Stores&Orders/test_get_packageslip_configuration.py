...
class TestGetPackageSlipConfiguration(common_utils):
    ...
    def test_get_packageslip_configuration(self,resource):
        res = resource['store'].get_packageslip_configuration()
