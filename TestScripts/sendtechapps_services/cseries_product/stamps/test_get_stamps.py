...
class TestStamps(common_utils):
    ...
    @pytest.mark.skip(reason="get_stamps_rollType function need to rewrite")
    def test_verify_get_stampsRollType(self, resource):

        res = resource['subscription'].get_stamps_rollType()
