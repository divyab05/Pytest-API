...
from APIObjects.analytics_services.kpis_api import KpisAPI
...
def resource(app_config, generate_access_token):
    kpis_api = {}
    kpis_api['app_config'] = app_config
    kpis_api['kpis_api'] = KpisAPI(app_config, generate_access_token)
    kpis_api['data_reader'] = DataReader(app_config)
    yield kpis_api

@pytest.mark.usefixtures('initialize')
class TestKpisAPI(common_utils):
    ...
    def class_level_setup(self, request,resource):
        ...
        """
        self.configparameter = "KPIS_API_MGMT"
    ...
    def test_01_verify_kpis_api_response(self, rp_logger, resource):
        """
        ...
        res, status_code = resource['kpis_api'].verify_kpis_api_status_code()
    ...
    @pytest.mark.sendpro_analytics_api_snowflake_sp360commercial
    @pytest.mark.sendpro_analytics_api_snowflake_fedramp
    def test_02_verify_kpis_api_response_with_expired_token(self, rp_logger, resource):
        """
        ...
        et = "yes"
        res, status_code = resource['kpis_api'].verify_kpis_api_response_authorisation(et)
    ...
    @pytest.mark.sendpro_analytics_api_snowflake_sp360commercial
    @pytest.mark.sendpro_analytics_api_snowflake_fedramp
    def test_03_verify_kpis_api_response_schema(self, rp_logger, resource):
        """
        ...
        with open(
                'response_schema/analytics_services/kpis_api/kpis.json',
                'r') as s:
