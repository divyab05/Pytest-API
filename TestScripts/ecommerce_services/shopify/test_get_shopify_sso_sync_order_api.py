...
class Test_get_sync_order_api(common_utils):
    ...
    def test_sync_order_shopify_sso_api_with_warehouse_flg(self, resource, get_integrator_id, generate_access_token,
                                                           context):
    ...
    def test_sync_order_shopify_sso_api_with_expired_token(self, generate_access_token, resource, get_integrator_id,
                                                           context):
    ...
    def test_sync_order_shopify_sso_api_with_invalid_path(self, generate_access_token, resource, get_integrator_id,
                                                          context):
    ...
    def test_sync_order_shopify_sso_api_with_invalid_header(self, generate_access_token, resource, get_integrator_id,
                                                            context):
        resp = resource.send_get_sync_order_request(get_integrator_id, 'valid_token', generate_access_token, 'invalid',
                                                    context,"shopify")
