...
class Test_get_order_job_status_api(common_utils):

    @pytest.mark.ecom_services_sso
    @pytest.mark.ecommerce_services_sso
    ...
    def test_get_order_job_status_shopify_sso_api(self, resource, get_integrator_id, generate_access_token, context):
        resp = resource.send_get_order_job_status_request(get_integrator_id, context['X-PB-TransactionId'],
                                                          'valid_token', generate_access_token, None,"shopify")
    ...
    @pytest.mark.ecommerce_services
    @pytest.mark.ecommerce_services_sso
    @pytest.mark.ecommerce_services_sp360commercial_smoke
    @pytest.mark.ecommerce_services_sp360commercial_reg
    @pytest.mark.ecommerce_services_sp360commercial
    @pytest.mark.order(26)
    def test_get_order_job_status_shopify_sso_with_invalid_header(self, resource, get_integrator_id,
        ...
        resp = resource.send_get_order_job_status_request(get_integrator_id, transaction_id, 'valid_token',
                                                          generate_access_token, None,"shopify")
    ...
    def test_order_job_status_shopify_sso_with_expired_token(self, generate_access_token, resource, get_integrator_id,
                                                             context):
        resp = resource.send_get_order_job_status_request(get_integrator_id, context['X-PB-TransactionId'],
                                                          'invalid_token', generate_access_token, None,"shopify")
