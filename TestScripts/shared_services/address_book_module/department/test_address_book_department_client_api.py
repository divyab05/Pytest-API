...
class TestAddrbookDept_Client_API(common_utils):
    ...
    def test_01_verify_search_dept_in_sub_id_client_api(self, resource):
        """
        ...
        add_dept_resp = (resource['addressbook_api']
                         .add_dept_api(name=name, loc_id=loc_id, sub_id=sub_id, client_token=user_token))
        assert_that(self.validate_response_code(add_dept_resp, 201))
        created_dept_id = add_dept_resp.json()['departmentID']

        get_dept_resp = resource['addressbook_api'].get_departments_api(sub_id=sub_id, client_token=user_token)
    ...
    @pytest.mark.address_book_sp360commercial_reg
    def test_02_verify_search_dept_by_location_id_client_api(self, resource):
        """
        ...
        search_dept_resp = (resource['addressbook_api']
                            .search_dept_with_query_api(sub_id=sub_id, query=name, client_token=user_token))
    ...
    @pytest.mark.address_book_sp360commercial
    @pytest.mark.address_book_sp360commercial_reg
    def test_03_verify_search_dept_by_invalid_location_id_client_api(self, resource):
        """
        ...
        get_invalid_dept_resp = (resource['addressbook_api'].get_dept_by_dept_id_loc_id_api(
            sub_id=sub_id, dept_id=invalid_dept, loc_id=loc_id, client_token=user_token))
    ...
    @pytest.mark.address_book_sp360commercial_smoke
    @pytest.mark.address_book_sp360commercial_reg
    def test_04_verify_add_dept_with_loc_client_api(self, resource):
        """
        ...
        get_dept_resp = (resource['addressbook_api'].get_dept_by_dept_id_loc_id_api(
            sub_id=sub_id, dept_id=created_dept_id, loc_id=loc_id, client_token=user_token))
        assert_that(self.validate_response_code(get_dept_resp, 200))
    ...
    @pytest.mark.address_book_sp360commercial
    @pytest.mark.address_book_sp360commercial_reg
    def test_05_verify_add_dept_without_loc_client_api(self, resource):
        """
        ...
        add_dept_resp = (resource['addressbook_api']
                         .add_dept_api(name=name, sub_id=sub_id, client_token=user_token))
        assert_that(self.validate_response_code(add_dept_resp, 201))
        created_dept_id = add_dept_resp.json()['departmentID']

        get_dept_resp = (resource['addressbook_api'].get_dept_by_dept_id_loc_id_api(
            sub_id=sub_id, dept_id=created_dept_id, client_token=user_token))
        assert_that(self.validate_response_code(get_dept_resp, 200))
    ...
    @pytest.mark.address_book_sp360commercial
    @pytest.mark.address_book_sp360commercial_reg
    def test_06_verify_update_dept_client_api(self, resource):
        """
        ...
        update_dept_resp = (resource['addressbook_api']
                            .update_dept_api(cont1=contact1, cont2=contact2, sub_id=sub_id, dept_id=created_dept_id,
    ...
    @pytest.mark.address_book_sp360commercial
    @pytest.mark.address_book_sp360commercial_reg
    def test_07_verify_get_contact_details_client_api(self, resource):
        """
    ...
    @pytest.mark.address_book_sp360commercial
    @pytest.mark.address_book_sp360commercial_reg
    def test_08_verify_search_dept_by_search_query_client_api(self, resource):
        """
    ...
    @pytest.mark.address_book_sp360commercial
    @pytest.mark.address_book_sp360commercial_reg
    def test_09_verify_search_dept_by_non_existent_search_query_client_api(self, resource):
        """
    ...
    def test_10_verify_patch_update_client_api(self, resource):
        """
        This test validates that departments can be updated successfully (positive scenario)
        :return: return test status
        """
        ...
        with allure.step(
            ...
            add_dept_resp = resource['addressbook_api'].add_dept_api(name=name, loc_id=loc_id)
        ...
        with allure.step("Validate that Department with location is added successfully: "):
            if status_code != 201:
                ...
                with allure.step("Fetch the created department: "):
                    get_dept_resp = resource['addressbook_api'].get_dept_by_dept_id_loc_id_api(dept_id=created_dept_id,
                                                                                               loc_id=loc_id)
                    ...
                    if status_code != 200:
                        err_desc = res['errors'][0]['errorDescription']
                        self.Failures.append(
                            "There is a failure in fetching the created department. Expected:200 , Received : " + str(
                                status_code) + " , Obtained error message is: " + str(err_desc))

                    else:
                        with allure.step("Update the created department using PATCH API: "):
                            res, status_code = resource['addressbook_api'].patch_update_dept_api(oprtn_typ='add',
                                                                                                 cont1=contact1,
                                                                                                 cont2=contact2,
                                                                                                 is_admin='n',
                            ...
                            if status_code != 200:
                                err_desc = res['errors'][0]['errorDescription']
                                self.Failures.append(
                                    "There is a failure in adding contacts to the created department. Expected:200 , Received : " + str(
                                        status_code) + " , Obtained error message is: " + str(err_desc))
                                ...
                                with allure.step("Fetch the updated department: "):
                                    ...
                                    if status_code != 200:
                                        ...
                                        if len(contacts_added) == 0:
                                            self.Failures.append(
                                                "Contacts are not added to the department. Expected contacts > 0. ")

                                        else:
                                            with allure.step(
                                                    "Delete the added contacts from department using PATCH API: "):
                                                res, status_code = resource['addressbook_api'].patch_update_dept_api(
                                                    oprtn_typ='delete', cont1=contact1, cont2=contact2,
                                                    is_admin='n',
                                                    dept_id=created_dept_id)
                                                if status_code != 200:
                                                    err_desc = res['errors'][0]['errorDescription']
                                                    self.Failures.append(
                                                        "There is a failure in deleting the added contacts. Expected:200 , Received : " + str(
                                                            status_code) + " , Obtained error message is: " + str(
                                                            err_desc))

                                                else:
                                                    with allure.step("Fetch the updated department: "):
                                                        get_dept_resp = resource[
                                                            'addressbook_api'].get_dept_by_dept_id_loc_id_api(
                                                            dept_id=created_dept_id,
                                                            loc_id=loc_id)
                                                        res = get_dept_resp.json()
                                                        status_code = get_dept_resp.status_code
                                                        if status_code != 200:
                                                            ...
                                                            if len(contacts_added) != 0:
                                                                self.Failures.append(
                                                                    "Contacts are not deleted from the department. Expected contacts = 0. ")

                with allure.step("Delete the created Department: "):
                    status_code = resource['addressbook_api'].delete_dept_by_dept_id_loc_id_api(is_admin='n',
                                                                                                dept_id=created_dept_id, loc_id=loc_id)
                    if status_code != 200:
                        err_desc = res['errors'][0]['errorDescription']
    ...
    @pytest.mark.address_book_sp360commercial_reg
    def test_11_verify_import_contacts_in_dept_client_api(self, resource):
        """
                ...
                with allure.step("Fetch the created department: "):
                    ...
                    if status_code != 200:
                        ...
                        with allure.step("Import contacts in created department using PATCH API: "):
                            res, status_code = resource['addressbook_api'].import_contacts_in_dept_api(
                                is_admin='n', dept_id=created_dept_id)
                            if status_code != 200:
                                err_desc = res['errors'][0]['errorDescription']
                                self.Failures.append(
                                    "There is a failure in importing contacts to the created department. Expected:200 , Received : " + str(
                                        status_code) + " , Obtained error message is: " + str(err_desc))
