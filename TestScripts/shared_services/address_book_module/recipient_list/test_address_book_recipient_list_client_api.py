...
class TestAddressbook_Recipient_ClientAPI:
    ...
    def test_01_verify_add_recipient_list_client_api(self, resource):
        """
        ...
        with allure.step(
            ...
            name = "AUTO_Test_rec_list_" + str(random.randint(1, 500))
            get_row_data = resource['data_reader'].pd_get_row_data(self.configparameter, test_name)
            sub_id = str(get_row_data['subId'])

            create_recipient_resp = resource['addressbook_api'].create_recipient_list_api(name=name, sub_id=sub_id)
            ...
            if status_code != 201:
                ...
                if len(isValid) > 0:
                    ...
                    with allure.step("Delete the created recipient list: "):
                        status_code = resource['addressbook_api'].verify_delete_recipient_api(sub_id=sub_id, is_admin='n',
    ...
    @pytest.mark.address_book_sp360commercial
    @pytest.mark.address_book_sp360commercial_reg
    def test_02_verify_add_contacts_to_recipient_list_client_api(self, resource):
        """
    ...
    @pytest.mark.address_book_sp360commercial
    @pytest.mark.address_book_sp360commercial_reg
    def test_03_verify_delete_contacts_from_recipient_list_client_api(self, resource):
        """
        ...
        with allure.step(
            ...
            create_recipient_resp = resource['addressbook_api'].create_recipient_list_api(name=name, sub_id=sub_id, is_admin=False)
            res = create_recipient_resp.json()
            status_code = create_recipient_resp.status_code
                                    ...
                                    if updt_count < total_count:
                                        ...
                                        with allure.step("Remove contacts from the created list: "):
                                            patch_rect_resp = resource[
                                                ...
                                                operation_type='delete', cont1=cont1, cont2=cont2, sub_id=sub_id,
                                                rect_id=created_rec_id)
                                            res = patch_rect_resp.json()
                                            status_code = patch_rect_resp.status_code
                                            if status_code != 200:
    ...
    @pytest.mark.address_book_sp360commercial
    @pytest.mark.address_book_sp360commercial_reg
    def test_04_verify_add_duplicate_recipient_list_client_api(self, resource):
        """
            ...
            if status_code != 201:
                ...
                if len(isValid) > 0:
                    ...
                    with allure.step(
                        ...
                        create_recipient_resp = resource['addressbook_api'].create_recipient_list_api(name=name,
                                                                                                      sub_id=sub_id)
                        res = create_recipient_resp.json()
                        status_code = create_recipient_resp.status_code
    ...
    @pytest.mark.address_book_sp360commercial_smoke
    @pytest.mark.address_book_sp360commercial_reg
    def test_05_verify_get_recipient_by_id_client_api(self, resource):
        """
    ...
    @pytest.mark.address_book_sp360commercial
    @pytest.mark.address_book_sp360commercial_reg
    def test_06_verify_get_recipient_by_invalid_id_client_api(self, resource):
        """
    ...
    @pytest.mark.address_book_sp360commercial
    @pytest.mark.address_book_sp360commercial_reg
    def test_07_verify_update_recipient_list_client_api(self, resource):
        """
    ...
    @pytest.mark.address_book_sp360commercial
    @pytest.mark.address_book_sp360commercial_reg
    def test_08_verify_search_recipient_in_sub_id_client_api(self, resource):
        """
    ...
    @pytest.mark.address_book_sp360commercial
    @pytest.mark.address_book_sp360commercial_reg
    def test_09_verify_search_recipient_by_search_query_client_api(self, resource):
        """
    ...
    @pytest.mark.address_book_sp360commercial
    @pytest.mark.address_book_sp360commercial_reg
    def test_10_verify_search_recipient_by_non_existent_search_query_client_api(self, resource):
        """
    ...
    @pytest.mark.address_book_sp360commercial_reg
    def test_11_verify_add_recipient_list_without_name_client_api(self, resource):
        """
    ...
    @pytest.mark.address_book_sp360commercial_reg
    def test_12_verify_get_contacts_from_rec_list_client_api(self, resource):
        """
