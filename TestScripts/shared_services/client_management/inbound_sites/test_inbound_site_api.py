...
class TestInboundSiteAdminAPI(common_utils):
    ...
    def test_add_site_api(self, rp_logger, resource):
        """
        ...
        add_site_res, status_code = resource['client_mgmt'].verify_add_site_api(is_admin='Y', sub_id=sub_id,
                                                                                name=site_name,
                                                                                type=type)
        ...
        get_inbound_site_res, status_code = resource['client_mgmt'].verify_get_inbound_site_by_id_api(is_admin='Y',
                                                                                                      sub_id=sub_id,
        ...
        res, status_code = resource['client_mgmt'].verify_get_inbound_site_by_id_api(is_admin='Y',
                                                                                     sub_id=sub_id,
                                                                                     site_id=created_site_id)
    ...
    @pytest.mark.client_management_sp360commercial
    @pytest.mark.client_management_sp360commercial_reg
    def test_add_duplicate_site_api(self, rp_logger, resource):
        """
        ...
        add_dup_site_res, status_code = resource['client_mgmt'].verify_add_site_api(is_admin='Y', sub_id=sub_id,
                                                                                    name=site_name,
                                                                                    type=type)
    ...
    @pytest.mark.client_management_sp360commercial
    @pytest.mark.client_management_sp360commercial_reg
    def test_add_inbound_sites_api(self, rp_logger, resource):
        """
        ...
        add_site_res, add_site_status_code = resource['client_mgmt'].verify_add_site_api(is_admin='Y', sub_id=sub_id,
                                                                                         name=site_name,
                                                                                         type=type)
        ...
        search_param = 'searchBy=type:' + type
        ...
        #     assert_that((search_by_site_type_res['inboundsites'][i]['type']), type)

        validate_site_type = resource['client_mgmt'].verify_site_type(search_by_site_type_res, type)

        assert_that(validate_site_type, equal_to(True))
        ...
        add_inbound_site_res, add_inbound_site_status_code = resource['client_mgmt'].verify_add_inbound_site_api(
            is_admin='Y', sub_id=sub_id, name=build_site_name, parent_id=parent, type=type)
        ...
        get_inbound_site_res, get_inbound_site_res_status_code = resource[
            'client_mgmt'].verify_get_inbound_site_by_id_api(is_admin='Y',
                                                             sub_id=sub_id,
        ...
        # Fetch the type building

        search_param = 'searchBy=type:' + type

        # Fetch the created site with searchBy Type API

        search_by_building_type_res, search_by_building_type_status_code = resource['client_mgmt'].verify_get_inbound_site_by_search_criteria_api(is_admin='Y',
                                                                          sub_id=sub_id,
                                                                          search_param=search_param)

        assert_that(search_by_building_type_status_code, equal_to(200))

        validate_site_type = resource['client_mgmt'].verify_site_type(search_by_building_type_res, type)
        ...
        res, status_code = resource['client_mgmt'].verify_add_inbound_site_api(is_admin='Y', sub_id=sub_id,
        ...
        res, status_code = resource['client_mgmt'].verify_get_inbound_site_by_id_api(is_admin='Y', sub_id=sub_id,
        ...
        # Fetch the created office site by search API
        search_param = 'query=' + office_site_name

        search_res, search_status_code = resource['client_mgmt'].verify_get_inbound_site_by_search_criteria_api(
            is_admin='Y', sub_id=sub_id,
            search_param=search_param)

        assert_that(search_status_code, equal_to(200))

        site_name = search_res['inboundsites'][0]['name']

        assert_that(site_name, equal_to(office_site_name))
        ...
        #fetch the floor type

        search_param = 'searchBy=type:' + type

        # Fetch the created site with searchBy Type API

        search_by_flr_type_res, search_by_flr_type_status_code = resource[
            'client_mgmt'].verify_get_inbound_site_by_search_criteria_api(is_admin='Y',
                                                                          sub_id=sub_id,
                                                                          search_param=search_param)
        assert_that(search_by_flr_type_status_code, equal_to(200))

        validate_site_type = resource['client_mgmt'].verify_site_type(search_by_flr_type_res, type)
        ...
        #fetch by mailstop type

        search_param = 'searchBy=type:' + type

        # Fetch the created site with searchBy Type API

        search_by_mailstop_type_res, search_by_mailstop_type_status_code = resource[
            'client_mgmt'].verify_get_inbound_site_by_search_criteria_api(is_admin='Y',
                                                                          sub_id=sub_id,
                                                                          search_param=search_param)
        assert_that(search_by_mailstop_type_status_code, equal_to(200))

        validate_site_type = resource['client_mgmt'].verify_site_type(search_by_mailstop_type_res, type)

        assert_that(validate_site_type, equal_to(True))

        # "Delete the created mailstop site":
        status_code = resource['client_mgmt'].verify_delete_inbound_site_by_id_api(is_admin='Y', sub_id=sub_id,
                                                                                   site_id=mailstop_site_id)
    ...
    @pytest.mark.client_management_sp360commercial_smoke
    @pytest.mark.client_management_sp360commercial_reg
    def test_update_inbound_sites_building_api(self, rp_logger, resource):
        """
        ...
        # "Call add site API and verify the response":
        res, status_code = resource['client_mgmt'].verify_add_site_api(is_admin='Y', sub_id=sub_id, name=site_name,
                                                                       type=type)
        assert_that(status_code, equal_to(201))
        ...
        update_site_resp = resource['client_mgmt'].verify_update_site_api(is_admin=True, sub_id=sub_id,
    ...
    @pytest.mark.client_management_sp360commercial
    @pytest.mark.client_management_sp360commercial_reg
    def test_update_inbound_sites_longer_name_api(self, rp_logger, resource):
        """
    ...
    @pytest.mark.client_management_sp360commercial
    @pytest.mark.client_management_sp360commercial_reg
    def test_delete_parent_with_active_child(self, resource):
        """
    ...
    @pytest.mark.client_management_sp360commercial
    @pytest.mark.client_management_sp360commercial_reg
    def test_add_site_with_invalid_type_api(self, rp_logger, resource):
        """
        ...
        err_code = str(res['errors'][0]['errorCode'])
        err_desc = str(res['errors'][0]['errorDescription'])

        assert_that(err_code, equal_to('validation_error'))
        assert_that(err_desc, equal_to('Invalid Request - Please provide valid SubscriptionID'))

    @pytest.mark.client_management_sp360commercial
    @pytest.mark.client_management_sp360commercial_smoke
    @pytest.mark.client_management_sp360commercial_reg
    def test_get_inbound_site_by_location_api(self, rp_logger, resource):
        """
        This test validates that inbound sites can be fetched by location Id (positive scenario)
        :return: return test status
        """
        test_name = inspect.currentframe().f_code.co_name
        self.log.info(f'###### TEST EXECUTION STARTED :: {test_name} ######')
        ...
        # "Call add site API and verify the response":
        add_site_res, status_code = resource['client_mgmt'].verify_add_site_with_location_api(is_admin='Y', sub_id=sub_id,
                                                                                name=site_name,
                                                                                type=type, location_id=created_loc_id)
        assert_that(status_code, equal_to(201))

        created_site_id = add_site_res['inboundSiteID']

        get_site_by_loc_id, status_code = resource['client_mgmt'].verify_get_inbound_site_by_loc_id_api(is_admin='Y', sub_id=sub_id, loc_id=created_loc_id)

        assert_that(status_code, equal_to(200))

        # Delete the created site":
        status_code = resource['client_mgmt'].verify_delete_inbound_site_by_id_api(is_admin='Y',sub_id=sub_id,site_id=created_site_id)
    ...
    @pytest.mark.client_management_sp360commercial
    @pytest.mark.client_management_sp360commercial_reg
    def test_fetch_active_inbound_sites_api(self, rp_logger, resource):
        """
    ...
    def test_delete_associated_location_reference_check_api(self, rp_logger, resource):
        """
        ...
        get_site_by_loc_id, status_code = resource['client_mgmt'].verify_get_inbound_site_by_loc_id_api(is_admin='Y',
                                                                                                        sub_id=sub_id,
        ...
        del_v2_locn_res, del_loc_status_code = resource['client_mgmt'].delete_location_v2_api(is_admin=True,
                                                                                              sub_id=sub_id,
                                                                                              loc_id=created_loc_id)
        ...
        del_loc_res = resource['client_mgmt'].delete_location_v2_api(is_admin=True, sub_id=sub_id, loc_id=created_loc_id)
